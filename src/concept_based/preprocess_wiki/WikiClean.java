...
//        String content = getWikiMarkup(page);
    ...
    private static final Pattern FOOTER_ES1 = Pattern.compile("==\\s*Véase también\\s*==.*",
            Pattern.CASE_INSENSITIVE | Pattern.DOTALL);
    private static final Pattern FOOTER_ES2 = Pattern.compile("==\\s*Referencias\\s*==.*",
            Pattern.CASE_INSENSITIVE | Pattern.DOTALL);
    private static final Pattern FOOTER_ES3 = Pattern.compile("==\\s*Bibliografía\\s*==.*",
            Pattern.CASE_INSENSITIVE | Pattern.DOTALL);
    private static final Pattern FOOTER_ES4 = Pattern.compile("==\\s*Enlaces externos\\s*==.*",
            Pattern.CASE_INSENSITIVE | Pattern.DOTALL);
    private static final Pattern FOOTER_ES5 = Pattern.compile("==\\s*Filmografía\\s*==.*",
            Pattern.CASE_INSENSITIVE | Pattern.DOTALL);
    ...
    private String removeFooter(String s) {
        ...
        } else if (lang.equals(WikiLanguage.ES)) {
            s = FOOTER_ES1.matcher(s).replaceAll("");
            s = FOOTER_ES2.matcher(s).replaceAll("");
            s = FOOTER_ES3.matcher(s).replaceAll("");
            s = FOOTER_ES4.matcher(s).replaceAll("");
            s = FOOTER_ES5.matcher(s).replaceAll("");
    ...
    private static final Pattern CATEGORY_LINKS_DE = Pattern
            .compile("\\[\\[Kategorie:([^\\]]+)\\]\\]");
    private static final Pattern CATEGORY_LINKS_ES = Pattern
            .compile("\\[\\[Categoría:([^\\]]+)\\]\\]");
    ...
    private String removeCategoryLinks(String s) {
        ...
        if (lang.equals(WikiLanguage.ES)) {
            return CATEGORY_LINKS_ES.matcher(s).replaceAll("");
        }
